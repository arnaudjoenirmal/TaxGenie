...
# Example usage
input_folder = "D:/TaxGenie/ocr/json_files"  # Update with your actual input folder
output_folder = "D:/TaxGenie/ocr/cleaned_json"  # Update with your desired output folder

...
# input_data = {"transactions": [{"id": 1, "amount": 100, "category": "Food"}]}
# print(process_groq_data(input_data))  # Synchronous
# asyncio.run(process_groq_data_async(input_data))  # Asynchronous

...
def process_groq_data(input_data: dict):
    ...
    system_message = """
    Extract tax-relevant details from the input. Return ONLY a valid JSON object with fields:
- "taxable_transactions": List of transactions related to tax.
- "total_tax_paid": Total tax-related debits.
- "summary": Key insights.

Ensure the output is valid JSON. No explanations, markdown, or backticks.
    """
